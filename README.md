# 🤖 InsightFlow AI Pipeline - Multi-Agent AI System
...
The **InsightFlow AI Pipeline** is a modular multi-agent system built with Python and Streamlit that transforms raw CSV data into meaningful business insights.
